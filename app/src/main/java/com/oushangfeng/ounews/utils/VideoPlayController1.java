...
public class VideoPlayController1 /*implements IMediaController*/ {
    ...
    private static class VideoHandler extends Handler {
        ...
        WeakReference<VideoPlayController1> mReference;

        VideoHandler(VideoPlayController1 controller1) {
    ...
    public VideoPlayController1(Activity context, PLVideoView videoView, View anchorView) {
        mContext = context;
