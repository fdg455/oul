 ...
 * UpdateDate:<p>
 */
public abstract class BaseSuperRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerViewHolder> {
    ...
    public BaseSuperRecyclerAdapter(Context context, List<T> data) {
        this(context, data, true);
    }

    public BaseSuperRecyclerAdapter(Context context, List<T> data, boolean useAnimation) {
        this(context, data, useAnimation, null);
    }

    public BaseSuperRecyclerAdapter(Context context, List<T> data, boolean useAnimation, RecyclerView.LayoutManager layoutManager) {
        mContext = context;
    ...
    public int getItemViewType(int position) {
        ...
        if (mEnableLoadMore && mShowLoadMoreView && getItemCount() - 1 == position) {
            return TYPE_MORE;
        }

        if (!mShowLoadMoreView && !mEnableLoadMore && getItemCount() - 1 == position) {
    ...
    public int getItemCount() {
        int i = (mEnableLoadMore && mShowLoadMoreView) || (!mShowLoadMoreView && !mEnableLoadMore) ? 1 : 0;
