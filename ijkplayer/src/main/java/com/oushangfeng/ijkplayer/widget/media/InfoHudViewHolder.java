...
public class InfoHudViewHolder {
    private com.oushangfeng.ijkplayer.widget.media.TableLayoutBinder mTableLayoutBinder;
    ...
    public InfoHudViewHolder(Context context, TableLayout tableLayout) {
        mTableLayoutBinder = new com.oushangfeng.ijkplayer.widget.media.TableLayoutBinder(context, tableLayout);
    }
