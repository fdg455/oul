package com.oushangfeng.ijkplayer.widget.view;
...
public class DropView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int w = com.oushangfeng.ijkplayer.widget.view.MeasureUtil.measureSize(widthMeasureSpec,
            com.oushangfeng.ijkplayer.widget.view.MeasureUtil.dip2px(getContext(), 25));
        final int h = com.oushangfeng.ijkplayer.widget.view.MeasureUtil.measureSize(heightMeasureSpec,
            com.oushangfeng.ijkplayer.widget.view.MeasureUtil.dip2px(getContext(), 25 * 1.5f));
